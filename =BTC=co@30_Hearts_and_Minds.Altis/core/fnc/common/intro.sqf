...
['\A3\ui_f\data\igui\cfg\simpleTasks\types\target_ca.paa',_color, [getPos flag_base select 0,getPos flag_base select 1,(getPos flag_base select 2) + 2], 1.1, 1.1, 0, "Schiessuebung", 1],
