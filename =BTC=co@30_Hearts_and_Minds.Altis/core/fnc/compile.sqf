...
btc_fnc_log_hitch_points = compile preprocessFile "core\fnc\log\hitch_points.sqf";
btc_fnc_log_get_corner_points = compile preprocessFile "core\fnc\log\get_corner_points.sqf";
