...
_pen setVectorUp vectorUp btc_log_vehicle_selected;
...
btc_log_vehicle_selected attachTo [_pen, [0, 0, 0.2 + abs(((btc_log_vehicle_selected modelToWorld [0,0,0]) select 2) - ((_pen  modelToWorld [0,0,0]) select 2))]];
